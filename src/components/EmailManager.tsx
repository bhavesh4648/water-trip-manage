...
const EmailManager = () => {
  const [emailSettings, setEmailSettings] = useState({
    ...
    password: '',
    fromEmail: '',
    fromName: 'AquaFlow Water Supply'
  })
  ...
  const handleSendManualEmail = () => {
    ...
    setTimeout(() => {
      ...
      setManualEmail(prev => ({ ...prev, to: '', body: 'Dear Sir/Madam,\n\nPlease find attached the monthly water delivery report.\n\nBest regards,\nAquaFlow Team' }))
    }, 3000)
  }
  ...
  const handleScheduleAutoEmails = () => {
    toast({
      ...
      description: "Monthly reports will be sent automatically on the 1st of each month",
    })
  }
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            ...
            <div>
              ...
              <Input
                ...
                placeholder="AquaFlow Water Supply"
                className="mt-1"
              />
            </div>
          </div>
        ...
        <CardContent>
          <div className="space-y-4">
            <div className="bg-ocean-light/20 p-4 rounded-lg">
              <h4 className="font-semibold text-ocean-deep mb-2">Automatic Email Schedule</h4>
              <p className="text-sm text-muted-foreground mb-4">
                Monthly reports will be automatically generated and sent to all clients on the 1st of each month at 9:00 AM.
              </p>
        ...
        <CardContent>
          <div className="space-y-4">
            {scheduledEmails.map((email) => (
              <div key={email.id} className="border border-ocean/20 rounded-lg p-4 bg-ocean-light/10">
                <div className="flex items-center justify-between">
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-2">
                      {getStatusIcon(email.status)}
                      <span className="font-medium text-ocean-deep">{email.subject}</span>
                    ...
                    <div className="text-sm text-muted-foreground space-y-1">
                      <div className="flex items-center gap-4">
                        ...
                        <span className="flex items-center gap-1">
                          ...
                          {format(new Date(email.scheduledDate), 'dd/MM/yyyy HH:mm')}
                        </span>
                        <span className="flex items-center gap-1">
